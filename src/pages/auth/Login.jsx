...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center bg-[#f9fafb] px-4 py-6 sm:py-8 font-sans text-gray-900">
            <div className="w-full flex flex-col items-center m-auto">
                <Toaster position="top-center" />
                
                {/* Logo area placed outside the card just like the design */}
                ...
                <div className="w-full max-w-[420px] bg-white rounded-xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100 p-6 sm:p-8">
                    ...
                    <button type="button" className="w-full flex items-center justify-center gap-2 py-2.5 border border-gray-200 rounded-md hover:bg-gray-50 transition-colors mb-5 text-[15px] font-medium text-gray-700">
                ...
                <p className="text-[14px] text-gray-500 text-center mt-5">
                    ...
                    <Link
                        to={ROUTES.USER?.SIGNUP || '/user/signup'}
